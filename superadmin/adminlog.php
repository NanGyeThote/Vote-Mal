...
$sql = "SELECT * FROM admin WHERE id NOT IN (1, 2)";
...
<body>
    <nav class="navbar">
        ...
        <div class="profile-menu-wrapper">
            <button class="profile-toggle-btn" onclick="toggleProfileMenu()">
                <img src="img/superadmin.jpg" alt="Profile Logo" class="profile-logo">
    ...
    <div class="container">
        ...
        <div class="admin-profile">
            <img src="img/adminlog.jpg" alt="Admin Image">
            <h1>Admin Logs</h1>
        </div>
    ...
    <tbody>
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<tr><td colspan='5' class='no-data'>No Admin found</td></tr>";
        }
        ?>
    </tbody>
</table>
